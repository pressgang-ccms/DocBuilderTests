...
<xsl:import href="/docbuilder-tests/static/docbook/xhtml/docbook.xsl"/>
<xsl:import href="/docbuilder-tests/static/docbook/xhtml/titlepage.xsl"/>
...
<xsl:template match="*" mode="process.root">
  ...
  <html>
    <head>
        ...
        <script src="/docbuilder-tests/static/javascript/jquery/jquery-2.0.2.min.js"></script>
        <script src="/docbuilder-tests/static/javascript/functions.js"></script>
        <script>
            initListeners();
        </script>
